        ...
        <Grid container spacing={2}>
          {!metrics
            ...
            },
            {
              ...
              color: "#0B6FBF",
              href: "/search/mno",
              tooltip: "Total signaling (SS7 / SCCP) carrier relationships declared across all active IR.21 MNO profiles (including primary and secondary gateway routes). Click to explore MNO / Customer connectivity details.",
            },
            {
              ...
              color: "#0B6FBF",
              href: "/search/mno",
              tooltip: "Total LTE Diameter Edge Agent (DSX / Diameter) routing relationships declared in IR.21 Section 20. Click to explore MNO / Customer connectivity details.",
            },
            {
              ...
              color: "#0B6FBF",
              href: "/search/mno",
              tooltip: "Total Data Roaming (GRX / IPX) provider relationships declared in IR.21 Section 17. Click to explore MNO / Customer connectivity details.",
            },
            {
